...
*/
// Operações necessárias e resposta a partir da linha abaixo
let resultadoDaSoma = numeros[0] + numeros[1] + numeros[2] + numeros[3] +
numeros[4] + numeros[5] + numeros[6]
numeros[numeros.length] = resultadoDaSoma
...
*/
// Operações necessárias e resposta a partir da linha abaixo
let tempSegundo = numeros[1]
let tempQuarto = numeros[3]
let tempSexto = numeros[5]

numeros[3] = tempSegundo
numeros[5] = tempQuarto
numeros[1] = tempSexto
...
*/
// Nova lista abaixo
const novaLista = [numeros[7], numeros[6], numeros[5]]
// Operações necessárias e resposta a partir da linha abaixo
