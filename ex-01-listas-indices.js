...
*/
// Operações necessárias e resposta a partir da linha abaixo
export const resposta08 =  [numeros[0] + numeros[1] + numeros[2] + numeros[3] + numeros[4] + numeros[5] + numeros[6]]
...
[numeros[5], numeros[3]] = [numeros[3], numeros[5]]
