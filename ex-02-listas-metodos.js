...
export const resposta01 = profissoes.push("programador(a)", "designer", "engennheiro(a)", "veterinário(a)","administrador(a)")
...
animais = animais.concat(invertebrados, vertebrados)
...
*/
// Operações necessárias e resposta a partir da linha abaixo
animais = animais.concat("lesma","morcego","salmão")
animais.reverse
