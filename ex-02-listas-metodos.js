...
*/
// Operações necessárias e resposta a partir da linha abaixo
itemRemovido2 = profissoes.shift()
...
*/
// Operações necessárias e resposta a partir da linha abaixo
let listaDasRemovidas = [itemRemovido, itemRemovido2]
profissoes = profissoes.concat(listaDasRemovidas)
...
*/
// Operações necessárias e resposta a partir da linha abaixo
ultimoItem1 = animais.pop()
ultimoItem2 = animais.pop()
ultimoItem3 = animais.pop()
animais.unshift(ultimoItem1, ultimoItem2, ultimoItem3)
...
// Operações necessárias e resposta a partir da linha abaixo
animais.reverse()
itemRemove1 = animais.shift()
itemRemove2 = animais.shift()
itemRemove3 = animais.shift()
animais.push(itemRemove1, itemRemove2, itemRemove3)
...
*/
// Operações necessárias e resposta a partir da linha abaixo
pedra1 = novaListaPedras.shift()
pedra2 = novaListaPedras.shift()
pedra3 = novaListaPedras.shift()
pedras.push(pedra1, pedra2, pedra3)
pedras.reverse()
...
preda5 = pedras.pop()
preda6 = pedras.pop()
let novaListaDePreda = [preda1, preda2, preda3, preda4, preda5, preda6]
export const resposta14 = novaListaDePreda
