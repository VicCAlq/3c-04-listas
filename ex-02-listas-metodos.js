...
*/
// Operações necessárias e resposta a partir da linha abaixo
let removido = profissoes.pop()
export const resposta02 = removido
...
*/
// Operações necessárias e resposta a partir da linha abaixo
let segundoRemovido = profissoes.shift()
export const resposta04 = segundoRemovido
...
// Operações necessárias e resposta a partir da linha abaixo
animais.reverse()
let animaisShift = animais.shift()
animais.push(animaisShift)
animaisShift = animais.shift()
animais.push(animaisShift)
animaisShift = animais.shift()
animais.push(animaisShift)
...
*/
// Operações necessárias e resposta a partir da linha abaixo
let pedrasMovidas = pedras.shift()
pedras.push(pedrasMovidas)
pedrasMovidas = pedras.shift()
pedras.push(pedrasMovidas)
pedrasMovidas = pedras.shift()
pedras.push(pedrasMovidas)
pedras.reverse()
...
// Operações necessárias e resposta a partir da linha abaixo
let listaNova = []
listaNova[0] = pedras.pop()
listaNova[1] = pedras.pop()
listaNova[2] = pedras.pop()
listaNova[3] = pedras.pop()
listaNova[4] = pedras.pop()
listaNova[5] = pedras.pop()
