...
const profissoes = ["programador(a)", "designer", "engenheiro(a)",
        "veterinário(a)", "administrador(a)"]
...
let novaLista = [itemRemovido, itemRemovido2]
...
*/
// Operações necessárias e resposta a partir da linha abaixo
const vertebrados = ["elefante", "leopardo", "porco-espinho"]
const invertebrados = ["polvo", "formiga", "caranguejo"]
const animais = []
...
animais.unshift(animaisRemovidos)
...
animais.reverse()
animais.shift() * 3
const animaisDeslocados = animais.shift()
animais.push(animaisDeslocados)
...
*/
// Operações necessárias e resposta a partir da linha abaixo
const novosAnimais = ["carcará", "morcego", "salmão"]
animais.contact(novosAnimais)
animais.reverse()
const novosAnimais2 = ["lesma", "borboleta", "ostra"]
animais.concat(novosAnimais2)
...
// Operações necessárias e resposta a partir da linha abaixo
const pedras = []
const novasPedras = ["quartzo", "basalto", "granito"]
pedras.concat(novasPedras)
pedras.reverse()
const pedrasExtras = ["calcário", "mármore", "mica"]
pedras.push(pedrasExtras)
...
const novasPedras3 = ["topázio", "lazurita", "ônix"]
pedras.concat(novasPedras3)
...
// Operações necessárias e resposta a partir da linha 
pedras.shift() * 3
const pedrasRemovidas = pedras.shift()
pedras.push(pedrasRemovidas2)
pedras.reverse()
...
// Operações necessárias e resposta a partir da linha abaixo
pedras.pop() * 6
const pedrasRemovidas2 = pedras.pop()
export const resposta14 = pedras
